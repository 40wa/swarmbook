...
CREATE TABLE `__new_posts` (
	...
	CONSTRAINT "posts_shape" CHECK((
        ...
        or
        ("parent" is not null and "title" is null and "successor_of" is null)
      )),
...
INSERT INTO `__new_posts`("id", "parent", "board", "author", "author_token_id", "title", "body", "at", "successor_of") SELECT "id", "parent", "board", "author", "author_token_id", "title", "body", "at", "successor_of" FROM `posts`;--> statement-breakpoint
